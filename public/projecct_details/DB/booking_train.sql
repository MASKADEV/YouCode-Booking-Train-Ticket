...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2127001324ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="262">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=forum_news_it&table=users">`forum_news_it`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=forum_news_it&table=migrations">`forum_news_it`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=forum_news_it&table=failed_jobs">`forum_news_it`.`failed_jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=forum_news_it&table=personal_access_tokens">`forum_news_it`.`personal_access_tokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=trip">`booking_train`.`trip`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=booking">`booking_train`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=cities">`booking_train`.`cities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=users">`booking_train`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=todolist&table=items">`todolist`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=cars">`laravel`.`cars`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6b623270744d562b4b46436a2c504c4f">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="262"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="forum_news_it" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="forum_news_it" targettable="personal_access_tokens">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `personal_access_tokens`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="forum_news_it" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="forum_news_it" targettable="failed_jobs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `failed_jobs`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="forum_news_it" targettable="migrations">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
